...
#define ROS_COMPAT_DEBUG_THROTTLE(p, ...) ROS_DEBUG_THROTTLE(p, __VA_ARGS__)
...
#define ROS_COMPAT_DEBUG_STREAM_THROTTLE(p, args) ROS_DEBUG_STREAM_THROTTLE(p, args)
#define ROS_COMPAT_INFO_STREAM_THROTTLE(p, args) ROS_INFO_STREAM_THROTTLE(p, args)
#define ROS_COMPAT_WARN_STREAM_THROTTLE(p, args) ROS_WARN_STREAM_THROTTLE(p, args)
#define ROS_COMPAT_ERROR_STREAM_THROTTLE(p, args) ROS_ERROR_STREAM_THROTTLE(p, args)
