...
if __name__ == "__main__":
    ...
    duration = rospy.get_param("~duration", 12)
    joint_control_topic_name = rospy.get_param("~joint_control_topic_name", "/hydrus_xi/joints_ctrl")
    ...
    while not rospy.is_shutdown():
        joint.position = [math.pi / 2.0, math.pi / 2.0, math.pi / 2.0]
        pub.publish(joint)
